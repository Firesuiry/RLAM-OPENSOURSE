...
class CEC_functions:
    def __init__(self, dim):
        # csv_file = open('D:\develop\swam\CEC-single-test-suite\cec2013_func\extdata\M_D' + str(dim) + '.txt')
        csv_file = open(BASE_PATH+r'/data/cec2013/M_D' + str(dim) + '.txt')
        ...
        csv_file.close()
        # csv_file = open('D:\develop\swam\CEC-single-test-suite\cec2013_func\extdata\shift_data.txt')
        csv_file = open(BASE_PATH+r'/data/cec2013/shift_data.txt')
        csv_data = csv.reader(csv_file, delimiter=' ')
        self.sd = []
        for row in csv_data:
